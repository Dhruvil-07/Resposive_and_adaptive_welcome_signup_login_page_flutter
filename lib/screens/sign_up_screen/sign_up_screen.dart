...
//mobile sign up
class mobile_sign_up extends StatefulWidget {
  const mobile_sign_up({Key? key}) : super(key: key);

  @override
  State<mobile_sign_up> createState() => _mobile_sign_upState();
}

class _mobile_sign_upState extends State<mobile_sign_up> {
  @override
  Widget build(BuildContext context) {
    return Scaffold(
      body: SafeArea(
...
//tab sig up
class tab_sign_up extends StatefulWidget {
  const tab_sign_up({Key? key}) : super(key: key);

  @override
  State<tab_sign_up> createState() => _tab_sign_upState();
}

class _tab_sign_upState extends State<tab_sign_up> {
  @override
  Widget build(BuildContext context) {
    return Scaffold(
      body: SafeArea(
...
//web sign up
class web_sign_up extends StatefulWidget {
  const web_sign_up({Key? key}) : super(key: key);

  @override
  State<web_sign_up> createState() => _web_sign_upState();
}

class _web_sign_upState extends State<web_sign_up> {
  @override
  Widget build(BuildContext context) {
    return Scaffold(
      body:  SafeArea(
